...
Character.create(name: "V", hometown: "Night City", skill: "Netrunner", iconic_item: "The Scalpel")
Character.create(name: "Viktor Vector", hometown: "Watson", skill: "Ripperdoc", iconic_item: "Real Corrective Lenses")
Character.create(name: "Judy Alvarez", hometown: "Laguna Bend", skill: "Braindance Tech", iconic_item: "DMS Editing Bay")